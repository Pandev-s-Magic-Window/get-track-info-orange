// Taken from https://github.com/spicetify/cli/blob/main/globals.d.ts
declare namespace Spicetify {
  ...
  class URI {
     ...
     * @param args An array containing the arguments to the initApp.
  ...
  /**
   * Interface for interacting with Spotify client's initApp title
   */
  namespace AppTitle {
    /**
     * Set default initApp title. This has no effect if the player is running.
    ...
    /**
     * Reset initApp title to default
     */
    function reset(): Promise<void>;
    /**
     * Get current default initApp title
     * @return Current default initApp title
     */
    function get(): Promise<string>;
    /**
     * Subscribe to title changes.
     * This event is not fired when the player changes initApp title.
